...
<c:url var="R" value="/" />
	...
	<link type="text/css" rel="stylesheet" href="${R}css/chat.css"/>
	...
	function jstalktheme_addmsg(type, name, time, msg)
	{
		...
		if(type)
		{
			...
			onewmsg.innerHTML = 
			"<div class=\"profile_image\" style=\"background: url(/mongoChat/resources/img/profile_image.png) no-repeat;\">\n"+
			"</div>\n"+
			"<div class=\"box\">\n"+
	...
	function jstalktheme_testfunc()
	{
		...
		test_type ^= 0x01;
		jstalktheme_addmsg(test_type, "본인", ampm+" "+h+":"+m, otxtmsg.value.replace("\n","<br />\n"));
	}
